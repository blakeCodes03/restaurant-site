...
function Testimonial() {
  ...
  const fetchPost = async () => {
    await getDocs(collection(db, "Testimonials")).then((querySnapshot) => {
      ...
      newTestimonialArray = newData;
      randomNoRepeats(newTestimonialArray);
    });
  };
  ...
  function randomNoRepeats(array) { // function to randomly select 3 different testimonials from response(newData) without repeating 
    const freshTestimonialArray = [];
    ...
    for (let i = 0; i < 3; i++) {
      ...
      var item = copy[index];
      copy.splice(index, 1);
      freshTestimonialArray.push(item);
    }
   
    setTestimonials(freshTestimonialArray);
  }
  return (
    <div>
        ...
        <div className="mx-auto max-w-[1340px] px-4 py-16 sm:px-6 sm:py-24 lg:me-0 lg:pe-0 lg:ps-8">
          <div className="grid grid-cols-1 gap-y-8 lg:grid-cols-3 lg:items-center lg:gap-x-16">
            <div className="max-w-xl text-center ltr:sm:text-left rtl:sm:text-right">
              <h2 className="text-3xl font-bold tracking-tight sm:text-4xl curly-font">
              ...
              <div className="hidden lg:mt-8 lg:flex lg:gap-4">
                <button
                  ...
                  onClick={() => swiperEl.current.swiper.slidePrev()}
                >
                ...
                <button
                  ...
                  onClick={() => swiperEl.current.swiper.slideNext()}
                >
                  ...
                  <div className="swiper-slide">
                    <blockquote className="flex h-full flex-col justify-between bg-white p-12">
                      <div>
                        ...
                        <div className="mt-4">
                          <p className="text-2xl font-bold leading-relaxed text-black sm:text-xl">
